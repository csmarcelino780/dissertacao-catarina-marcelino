# -*- coding: utf-8 -*-
"""
Created on Mon Nov 20 17:20:46 2023
...
# Create a writer
with pd.ExcelWriter('ANN_scores_inverno_solar.xlsx') as writer:
...
# Create a writer
with pd.ExcelWriter('ANN_scores_inverno_load.xlsx') as writer:
    # Write each DataFrame to a different sheet
    method1_df.to_excel(writer, sheet_name='Method1', index=False)
    real_values_df.to_excel(writer, sheet_name='Real_Values', index=False)
...
# # Create a writer
# with pd.ExcelWriter('ann_scores_inverno.xlsx') as writer:
#     # Write each DataFrame to a different sheet
#     method1_df.to_excel(writer, sheet_name='Method1', index=False)
...
# # Create a writer
# with pd.ExcelWriter('Montly_ANN_scores_inverno.xlsx') as writer:
#     # Write each DataFrame to a different sheet
#     method1_df.to_excel(writer, sheet_name='Method1', index=True)
#     method2_df.to_excel(writer, sheet_name='Method2', index=True)

# # Create a writer
# with pd.ExcelWriter('ANN_weekday_scores_inverno.xlsx') as writer:
