# -*- coding: utf-8 -*-
"""
Created on Thu Nov 16 14:20:16 2023
...
july_mae = np.mean(hourly_mae[:31 * 24])  # MAE for July
august_mae = np.mean(hourly_mae[31 * 24:])  # MAE for August


print("Average RMSE for July:", july_rmse)
print("Average RMSE for August:", august_rmse)
print("Average MSE for July:", july_mse)
print("Average MSE for August:", august_mse)
print("Average MAE for July:", july_mae)
print("Average MAE for August:", august_mae)
...
july_mae_solar = np.mean(hourly_mae_solar[:31 * 24])  # MAE for July for solar data
august_mae_solar = np.mean(hourly_mae_solar[31 * 24:])  # MAE for August for solar data

print("Average RMSE for July (Solar):", july_rmse_solar)
print("Average RMSE for August (Solar):", august_rmse_solar)
print("Average MSE for July (Solar):", july_mse_solar)
print("Average MSE for August (Solar):", august_mse_solar)
print("Average MAE for July (Solar):", july_mae_solar)
print("Average MAE for August (Solar):", august_mae_solar)
...
real_solar_prediction_days = solar_real_resampled.loc[solar_real_resampled.index.month.isin([7, 8])]['PV50']  # Assuming solar data is used for solar_real
...
# Create a writer
with pd.ExcelWriter('KNN_scores_verao_solar.xlsx') as writer:
...
# Create a writer
with pd.ExcelWriter('KNN_scores_verao_load.xlsx') as writer:
    # Write each DataFrame to a different sheet
    method1_df.to_excel(writer, sheet_name='Method1', index=False)
    real_values_df.to_excel(writer, sheet_name='Real_Values', index=False)
...
# # Create a writer
# with pd.ExcelWriter('knn_scores_verao.xlsx') as writer:
#     # Write each DataFrame to a different sheet
#     method1_df.to_excel(writer, sheet_name='Method1', index=False)
...
# # Create a writer
# with pd.ExcelWriter('Montly_KNN_scores_verao.xlsx') as writer:
#     # Write each DataFrame to a different sheet
...
# # Create a writer
# with pd.ExcelWriter('KNN_weekday_scores_verao.xlsx') as writer:
