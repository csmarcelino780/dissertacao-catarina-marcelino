# -*- coding: utf-8 -*-
"""
Created on Tue Nov 21 09:07:05 2023
...
for scenario in scenarios:
    ...
    modified_data['Total_PV_Production_{}'.format(name)] = modified_data['Power'] * pv_installed
...
pv_production.to_csv('PVproduction_modified_2.csv', index=False)

# Save the modified DataFrame to an Excel file with Min-Max normalized values
pv_production.to_excel('PVproduction_modified_3.xlsx', index=False)
