# -*- coding: utf-8 -*-
"""
Created on Mon Nov 20 09:13:16 2023
...
sarima_model_solar = SARIMAX(endog=solar_data['PV50'], order=best_order, seasonal_order=best_seasonal_order)
...
# Combine the data from both months for net consumption
combined_hourly_rmse_data_net = np.concatenate((hourly_rmse_nov_nl1_reshaped, hourly_rmse_dec_nl1_reshaped), axis=1)
combined_hourly_mse_data_net = np.concatenate((hourly_mse_nov_nl1_reshaped, hourly_mse_dec_nl1_reshaped), axis=1)
combined_hourly_mae_data_net = np.concatenate((hourly_mae_nov_nl1_reshaped, hourly_mae_dec_nl1_reshaped), axis=1)
combined_hourly_mape_data_net = np.concatenate((hourly_mape_nov_nl1_reshaped, hourly_mape_dec_nl1_reshaped), axis=1)

# Calculate the mean for each hour across all days in Nov and Dec for net consumption
overall_mean_rmse_per_hour_net = np.mean(combined_hourly_rmse_data_net, axis=1)
overall_mean_mse_per_hour_net = np.mean(combined_hourly_mse_data_net, axis=1)
overall_mean_mae_per_hour_net = np.mean(combined_hourly_mae_data_net, axis=1)
overall_mean_mape_per_hour_net = np.mean(combined_hourly_mape_data_net, axis=1)

# Create DataFrames for Mean RMSE in Nov and Dec for net consumption
rmse_df_net = pd.DataFrame({
    'Hour': range(24),
    'Mean_RMSE_Monday': overall_mean_rmse_per_hour_net,
    'Mean_RMSE_Tuesday': overall_mean_rmse_per_hour_net,
    'Mean_RMSE_Wednesday': overall_mean_rmse_per_hour_net,
    'Mean_RMSE_Thursday': overall_mean_rmse_per_hour_net,
    'Mean_RMSE_Friday': overall_mean_rmse_per_hour_net,
    'Mean_RMSE_Saturday': overall_mean_rmse_per_hour_net,
    'Mean_RMSE_Sunday': overall_mean_rmse_per_hour_net
})

# Create DataFrames for Mean MSE in Nov and Dec for net consumption
mse_df_net = pd.DataFrame({
    'Hour': range(24),
    'Mean_MSE_Monday': overall_mean_mse_per_hour_net,
    'Mean_MSE_Tuesday': overall_mean_mse_per_hour_net,
    'Mean_MSE_Wednesday': overall_mean_mse_per_hour_net,
    'Mean_MSE_Thursday': overall_mean_mse_per_hour_net,
    'Mean_MSE_Friday': overall_mean_mse_per_hour_net,
    'Mean_MSE_Saturday': overall_mean_mse_per_hour_net,
    'Mean_MSE_Sunday': overall_mean_mse_per_hour_net
})

# Create DataFrames for Mean MAE in Nov and Dec for net consumption
mae_df_net = pd.DataFrame({
    'Hour': range(24),
    'Mean_MAE_Monday': overall_mean_mae_per_hour_net,
    'Mean_MAE_Tuesday': overall_mean_mae_per_hour_net,
    'Mean_MAE_Wednesday': overall_mean_mae_per_hour_net,
    'Mean_MAE_Thursday': overall_mean_mae_per_hour_net,
    'Mean_MAE_Friday': overall_mean_mae_per_hour_net,
    'Mean_MAE_Saturday': overall_mean_mae_per_hour_net,
    'Mean_MAE_Sunday': overall_mean_mae_per_hour_net
})

# Create DataFrames for Mean MAPE in Nov and Dec for net consumption
mape_df_net = pd.DataFrame({
    'Hour': range(24),
    'Mean_MAPE_Monday': overall_mean_mape_per_hour_net,
    'Mean_MAPE_Tuesday': overall_mean_mape_per_hour_net,
    'Mean_MAPE_Wednesday': overall_mean_mape_per_hour_net,
    'Mean_MAPE_Thursday': overall_mean_mape_per_hour_net,
    'Mean_MAPE_Friday': overall_mean_mape_per_hour_net,
    'Mean_MAPE_Saturday': overall_mean_mape_per_hour_net,
    'Mean_MAPE_Sunday': overall_mean_mape_per_hour_net
})
...
# Combine the data from both months for net consumption
combined_hourly_rmse_data_net = np.concatenate((hourly_rmse_nov_net_reshaped, hourly_rmse_dec_net_reshaped), axis=1)
combined_hourly_mse_data_net = np.concatenate((hourly_mse_nov_net_reshaped, hourly_mse_dec_net_reshaped), axis=1)
combined_hourly_mae_data_net = np.concatenate((hourly_mae_nov_net_reshaped, hourly_mae_dec_net_reshaped), axis=1)
combined_hourly_mape_data_net = np.concatenate((hourly_mape_nov_net_reshaped, hourly_mape_dec_net_reshaped), axis=1)

# Calculate the mean for each hour across all days in July and August for net consumption
overall_mean_rmse_per_hour_net = np.mean(combined_hourly_rmse_data_net, axis=1)
overall_mean_mse_per_hour_net = np.mean(combined_hourly_mse_data_net, axis=1)
overall_mean_mae_per_hour_net = np.mean(combined_hourly_mae_data_net, axis=1)
overall_mean_mape_per_hour_net = np.mean(combined_hourly_mape_data_net, axis=1)

# Create DataFrames for Mean RMSE in Summer for net consumption
rmse_df_net_summer = pd.DataFrame({
    'Hour': range(24),
    'Mean_RMSE_Monday': overall_mean_rmse_per_hour_net,
    'Mean_RMSE_Tuesday': overall_mean_rmse_per_hour_net,
    'Mean_RMSE_Wednesday': overall_mean_rmse_per_hour_net,
...
# Create DataFrames for Mean MSE in Summer for net consumption
mse_df_net_summer = pd.DataFrame({
    'Hour': range(24),
    'Mean_MSE_Monday': overall_mean_mse_per_hour_net,
    'Mean_MSE_Tuesday': overall_mean_mse_per_hour_net,
    'Mean_MSE_Wednesday': overall_mean_mse_per_hour_net,
...
# Create DataFrames for Mean MAE in Summer for net consumption
mae_df_net_summer = pd.DataFrame({
    'Hour': range(24),
    'Mean_MAE_Monday': overall_mean_mae_per_hour_net,
    'Mean_MAE_Tuesday': overall_mean_mae_per_hour_net,
    'Mean_MAE_Wednesday': overall_mean_mae_per_hour_net,
...
# Create DataFrames for Mean MAPE in Summer for net consumption
mape_df_net_summer = pd.DataFrame({
    'Hour': range(24),
    'Mean_MAPE_Monday': overall_mean_mape_per_hour_net,
    'Mean_MAPE_Tuesday': overall_mean_mape_per_hour_net,
    'Mean_MAPE_Wednesday': overall_mean_mape_per_hour_net,
...
# Create a writer
with pd.ExcelWriter('SARIMA_scores_inverno_solar.xlsx') as writer:
...
# Create a writer
with pd.ExcelWriter('SARIMA_scores_inverno_load.xlsx') as writer:
    # Write each DataFrame to a different sheet
    method1_df.to_excel(writer, sheet_name='Method1', index=False)
    real_values_df.to_excel(writer, sheet_name='Real_Values', index=False)
...
# # Combine the data from both July and August for Method1
# combined_method1_data = pd.concat([method1_df[method1_df['DateTime'].dt.month == 11], method1_df[method1_df['DateTime'].dt.month == 12]])
# overall_mean_method1 = combined_method1_data.mean()
# mean_method1_df = pd.DataFrame([overall_mean_method1], columns=["Hourly_RMSE", "Hourly_MSE", "Hourly_MAE", "Hourly_MAPE"])

# combined_method2_data = pd.concat([method2_df[method2_df['DateTime'].dt.month == 11], method2_df[method2_df['DateTime'].dt.month == 12]])
# overall_mean_method2 = combined_method2_data.mean()
# mean_method2_df = pd.DataFrame([overall_mean_method2], columns=["Hourly_RMSE", "Hourly_MSE", "Hourly_MAE", "Hourly_MAPE"])
#     # Add the Mean Values DataFrame to the Excel file
# # Create a writer
# with pd.ExcelWriter('SARIMA_scores_Inverno.xlsx') as writer:
#     # Write each DataFrame to a different sheet
#     method1_df.to_excel(writer, sheet_name='Method1', index=False)
#     method2_df.to_excel(writer, sheet_name='Method2', index=False)
#     real_values_df.to_excel(writer, sheet_name='Real_Values', index=False)
#     mean_method1_df.to_excel(writer, sheet_name='Mean_Method1_Summer', index=False)
#     mean_method2_df.to_excel(writer, sheet_name='Mean_Method2_Summer', index=False)
...
# # Create a writer
# with pd.ExcelWriter('Montly_SARIMA_scores_inverno.xlsx') as writer:
#     # Write each DataFrame to a different sheet
...
# # Create a writer
# with pd.ExcelWriter('SARIMA_weekday_scores_inverno.xlsx') as writer:
...
#     rmse_df_net.to_excel(writer, sheet_name='Mean_RMSE_Summer_m1', index=False)
#     mse_df_net.to_excel(writer, sheet_name='Mean_MSE_Summer_m1', index=False)
#     mae_df_net.to_excel(writer, sheet_name='Mean_MAE_Summer_m1', index=False)
#     mape_df_net.to_excel(writer, sheet_name='Mean_MAPE_Summer_m1', index=False)
    
#     rmse_df_net_summer.to_excel(writer, sheet_name='Mean_RMSE_Summer_m2', index=False)
#     mse_df_net_summer.to_excel(writer, sheet_name='Mean_MSE_Summer_m2', index=False)
#     mae_df_net_summer.to_excel(writer, sheet_name='Mean_MAE_Summer_m2', index=False)
#     mape_df_net_summer.to_excel(writer, sheet_name='Mean_MAPE_Summer_m2', index=False)
