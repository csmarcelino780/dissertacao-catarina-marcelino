...
# combined_method1_data = pd.concat([method1_df[method1_df['DateTime'].dt.month == 7], method1_df[method1_df['DateTime'].dt.month == 8]])
...
# combined_method2_data = pd.concat([method2_df[method2_df['DateTime'].dt.month == 7], method2_df[method2_df['DateTime'].dt.month == 8]])
