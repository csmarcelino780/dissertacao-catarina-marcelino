# -*- coding: utf-8 -*-
"""
Created on Fri Sep  6 21:10:57 2024
...
SARIMA_V25 = pd.ExcelFile(r"C:\Users\catar\OneDrive\OneDrive - Universidade de Lisboa\Ambiente de Trabalho\TESE\Codigo atualizado - 16 de Novembro\SARIMA\PV25\SARIMA_scores_verao_solar.xlsx")
SARIMA_I25 = pd.ExcelFile(r"C:\Users\catar\OneDrive\OneDrive - Universidade de Lisboa\Ambiente de Trabalho\TESE\Codigo atualizado - 16 de Novembro\SARIMA\PV25\SARIMA_scores_inverno_solar.xlsx")
SARIMA_V50 = pd.ExcelFile(r"C:\Users\catar\OneDrive\OneDrive - Universidade de Lisboa\Ambiente de Trabalho\TESE\Codigo atualizado - 16 de Novembro\SARIMA\PV50\SARIMA_scores_verao_solar.xlsx")
SARIMA_I50 = pd.ExcelFile(r"C:\Users\catar\OneDrive\OneDrive - Universidade de Lisboa\Ambiente de Trabalho\TESE\Codigo atualizado - 16 de Novembro\SARIMA\PV50\SARIMA_scores_inverno_solar.xlsx")


KNN_V25 = pd.ExcelFile(r"C:\Users\catar\OneDrive\OneDrive - Universidade de Lisboa\Ambiente de Trabalho\TESE\Codigo atualizado - 16 de Novembro\knn\pv25\knn_scores_verao_solar.xlsx")
KNN_I25 = pd.ExcelFile(r"C:\Users\catar\OneDrive\OneDrive - Universidade de Lisboa\Ambiente de Trabalho\TESE\Codigo atualizado - 16 de Novembro\knn\pv25\knn_scores_inverno_solar.xlsx")
KNN_V50 = pd.ExcelFile(r"C:\Users\catar\OneDrive\OneDrive - Universidade de Lisboa\Ambiente de Trabalho\TESE\Codigo atualizado - 16 de Novembro\knn\pv50\knn_scores_verao_solar.xlsx")
KNN_I50 = pd.ExcelFile(r"C:\Users\catar\OneDrive\OneDrive - Universidade de Lisboa\Ambiente de Trabalho\TESE\Codigo atualizado - 16 de Novembro\knn\pv50\knn_scores_inverno_solar.xlsx")


MLR_V25 = pd.ExcelFile(r"C:\Users\catar\OneDrive\OneDrive - Universidade de Lisboa\Ambiente de Trabalho\TESE\Codigo atualizado - 16 de Novembro\Regressao multipla variada\pv25\MLR_scores_verao_solar.xlsx")
MLR_I25 = pd.ExcelFile(r"C:\Users\catar\OneDrive\OneDrive - Universidade de Lisboa\Ambiente de Trabalho\TESE\Codigo atualizado - 16 de Novembro\Regressao multipla variada\pv25\MLR_scores_inverno_solar.xlsx")
MLR_V50 = pd.ExcelFile(r"C:\Users\catar\OneDrive\OneDrive - Universidade de Lisboa\Ambiente de Trabalho\TESE\Codigo atualizado - 16 de Novembro\Regressao multipla variada\pv50\MLR_scores_verao_solar.xlsx")
MLR_I50 = pd.ExcelFile(r"C:\Users\catar\OneDrive\OneDrive - Universidade de Lisboa\Ambiente de Trabalho\TESE\Codigo atualizado - 16 de Novembro\Regressao multipla variada\pv50\MLR_scores_inverno_solar.xlsx")


ANN_V25 = pd.ExcelFile(r"C:\Users\catar\OneDrive\OneDrive - Universidade de Lisboa\Ambiente de Trabalho\TESE\Codigo atualizado - 16 de Novembro\ANN\pv25\ANN_scores_verao_solar.xlsx")
ANN_I25 = pd.ExcelFile(r"C:\Users\catar\OneDrive\OneDrive - Universidade de Lisboa\Ambiente de Trabalho\TESE\Codigo atualizado - 16 de Novembro\ANN\pv25\ANN_scores_inverno_solar.xlsx")
ANN_V50 = pd.ExcelFile(r"C:\Users\catar\OneDrive\OneDrive - Universidade de Lisboa\Ambiente de Trabalho\TESE\Codigo atualizado - 16 de Novembro\ANN\pv50\ANN_scores_verao_solar.xlsx")
ANN_I50 = pd.ExcelFile(r"C:\Users\catar\OneDrive\OneDrive - Universidade de Lisboa\Ambiente de Trabalho\TESE\Codigo atualizado - 16 de Novembro\ANN\pv50\ANN_scores_inverno_solar.xlsx")
...
def calculate_metrics(real_values, forecasted_values):
    ...
    for index, row in df.iterrows():
        rmse = np.sqrt(np.mean((row['Real_SOLAR'] - row['Forecasted_Values'])**2))
        mae = np.mean(np.abs(row['Real_SOLAR'] - row['Forecasted_Values']))
        mape = np.mean(np.abs((row['Real_SOLAR'] - row['Forecasted_Values']) / row['Real_SOLAR'])) * 100
...
def calculate_hourly_metrics(real_values, forecasted_values):
    ...
    for hour in range(24):
        ...
        rmse = np.sqrt(np.mean((hour_data['Real_SOLAR'] - hour_data['Forecasted_Values'])**2))
        mae = np.mean(np.abs(hour_data['Real_SOLAR'] - hour_data['Forecasted_Values']))
        mape = np.mean(np.abs((hour_data['Real_SOLAR'] - hour_data['Forecasted_Values']) / hour_data['Real_SOLAR'])) * 100
...
with pd.ExcelWriter('Metrics_metho1_with_heatmap_solar.xlsx') as writer:
    ...
    for i in range(0, len(excel_files), 2):
        ...
        plot_and_save_rmse_heatmap_side_by_side(rmse_heatmap_data1, rmse_heatmap_data2,
                                                f'{file1}_weekday_rmse_heatmap_solar.png', f'{file2}_weekday_rmse_heatmap_solar.png',
                                                'A', 'B')
